...
func main() {
	...
	var delegates = flag.String("delegates", "", "comma-separated list of domains you own "+
		...
		"Let's Encrypt via DNS challenge. Domain names can be are either suffixes (i.e. 'b.c' will match both 'b.c' and 'a.b.c')" +
		" or wildcards (i.e. 'a.*.c' will match 'a.b.c' but not 'a.c') Example: "+
		`-delegates=_acme-challenge.73-189-219-4.xip.nono.io=ns-437.awsdns-54.com.,_acme-challenge.73-189-219-4.xip.nono.io=ns-1097.awsdns-09.org.,_acme-challenge.*.xip.example-com=ns-1.awsdns.org"`)
